...
export function Profile() {
  return (
    <div className="space-y-6">
      ...
      <Card className="p-4 text-sm leading-relaxed"><Label>Resume snapshot</Label><Bullets items={["Mantha Yashwanth Bharadwaj — Application Engineer; Hyderabad; B.Tech CS, Andhra University, GPA 8.57 (2019–2023).", "Automation Engineer, Uber — May 2026 → present (JS automation, REST/GraphQL integration, data hydration, config-driven tooling).", "Application Engineer, BluSapphire Cyber Systems — Mar 2024 → May 2026 (EDR/NDR platform, 500+ endpoints; EDR OneAgent + Rule Builder).", "Freelance Full Stack Developer — Jul 2023 → Feb 2024 (India, UAE, UK, US; akemsgroup.com, globalindiagateway.com, manshispeaks.com, nehadixit.com); co-founder, Earn While You Learn Club (mentored 13 students).", "AWS Certified Developer Associate · Cloud Practitioner · Smart India Hackathon finalist 2022 · NCC A, B & C."]} /></Card>
      <div>
